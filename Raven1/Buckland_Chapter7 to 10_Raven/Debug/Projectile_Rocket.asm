; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30133.0 
	...
	TITLE	E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\Debug\Projectile_Rocket.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG172799 DB	'Rocket_MaxForce', 00H
$SG172800 DB	'Rocket_Mass', 00H
$SG172801 DB	'Rocket_MaxSpeed', 00H
$SG172802 DB	'Rocket_Scale', 00H
	ORG $+3
$SG172803 DB	'Rocket_Damage', 00H
	ORG $+2
$SG172804 DB	'Rocket_BlastRadius', 00H
	ORG $+1
$SG172805 DB	'E', 00H, ':', 00H, '\', 00H, 'D', 00H, 'e', 00H, 's', 00H
	...
	DB	00H, 'n', 00H, '\', 00H, 'a', 00H, 'r', 00H, 'm', 00H, 'o', 00H
	DB	'r', 00H, 'y', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'j'
	DB	00H, 'e', 00H, 'c', 00H, 't', 00H, 'i', 00H, 'l', 00H, 'e', 00H
	DB	'_', 00H, 'R', 00H, 'o', 00H, 'c', 00H, 'k', 00H, 'e', 00H, 't'
	DB	00H, '.', 00H, 'c', 00H, 'p', 00H, 'p', 00H, 00H, 00H
	ORG $+2
$SG172806 DB	't', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'e', 00H, 't', 00H
	DB	' ', 00H, '!', 00H, '=', 00H, ' ', 00H, 'V', 00H, 'e', 00H, 'c'
	DB	00H, 't', 00H, 'o', 00H, 'r', 00H, '2', 00H, 'D', 00H, '(', 00H
	DB	')', 00H, 00H, 00H
	ORG $+2
$SG172820 DB	'Rocket_ExplosionDecayRate', 00H
	ORG $+2
$SG182260 DB	'invalid argument', 00H
	ORG $+3
$SG182261 DB	'%s', 00H
	ORG $+1
$SG182262 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG182263 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG182264 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG182265 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG182450 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
...
xdata$x	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:__unwindfunclet$??0Rocket@@QAE@PAVRaven_Bot@@UVector2D@@@Z$0
	DD	016H
_volmd	DDSymXIndex: 	FLAT:__unwindfunclet$?InflictDamageOnBotsWithinBlastRadius@Rocket@@AAEXXZ$0
	DD	016H
voltbl	ENDS
xdata$x	SEGMENT
...
$LN7@Allocate_m:
	push	OFFSET $SG182260
	push	OFFSET $SG182261
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG182262
	push	2
	call	__CrtDbgReport
...
$LN12@Allocate_m:
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG182263
	push	OFFSET $SG182264
	push	OFFSET $SG182265
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\armory\Projectile_Rocket.cpp
_TEXT	SEGMENT
tv203 = -44						; size = 8
$T1 = -36						; size = 16
$T2 = -20						; size = 16
...
; 18   :         Raven_Projectile(target,
	...
	push	OFFSET $SG172799
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172800
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172801
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172802
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
	call	?GetDouble@Scriptor@@QAENPAD@Z		; Scriptor::GetDouble
	sub	esp, 8
	fstp	QWORD PTR [esp]
	push	OFFSET $SG172803
	call	?Instance@Raven_Scriptor@@SAPAV1@XZ	; Raven_Scriptor::Instance
	mov	ecx, eax
...
; 32   :    assert (target != Vector2D());
	...
	push	32					; 00000020H
	push	OFFSET $SG172805
	push	OFFSET $SG172806
	call	__wassert
	add	esp, 12					; 0000000cH
$LN3@Rocket:
