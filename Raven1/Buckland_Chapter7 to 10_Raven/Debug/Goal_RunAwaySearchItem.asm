; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30133.0 
	...
	TITLE	E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\Debug\Goal_RunAwaySearchItem.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
?colors@@3QBKB DD 0ffH					; colors
	...
	DD	0c8c8c8H
	DD	0e6e6ffH
$SG184801 DB	'invalid argument', 00H
	ORG $+3
$SG184802 DB	'%s', 00H
	ORG $+5
$SG184803 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
	DB	'unity\VC\Tools\MSVC\14.29.30133\include\xmemory', 00H
$SG184804 DB	'C', 00H, ':', 00H, '\', 00H, 'P', 00H, 'r', 00H, 'o', 00H
	...
	DB	00H
$SG184805 DB	's', 00H, 't', 00H, 'd', 00H, ':', 00H, ':', 00H, '_', 00H
	...
	DB	00H
	ORG $+2
$SG184806 DB	'"', 00H, 'i', 00H, 'n', 00H, 'v', 00H, 'a', 00H, 'l', 00H
	DB	'i', 00H, 'd', 00H, ' ', 00H, 'a', 00H, 'r', 00H, 'g', 00H, 'u'
	DB	00H, 'm', 00H, 'e', 00H, 'n', 00H, 't', 00H, '"', 00H, 00H, 00H
	ORG $+2
$SG185032 DB	'C:\Program Files (x86)\Microsoft Visual Studio\2019\Comm'
...
PUBLIC	?Activate@Goal_RunAwaySearchItem@@UAEXXZ	; Goal_RunAwaySearchItem::Activate
PUBLIC	?Process@Goal_RunAwaySearchItem@@UAEHXZ		; Goal_RunAwaySearchItem::Process
PUBLIC	?Terminate@Goal_RunAwaySearchItem@@UAEXXZ	; Goal_RunAwaySearchItem::Terminate
...
xdata$x	ENDS
voltbl	SEGMENT
_volmd	DDSymXIndex: 	FLAT:__unwindfunclet$?Activate@Goal_RunAwaySearchItem@@UAEXXZ$0
	DD	01dH
voltbl	ENDS
xdata$x	SEGMENT
__unwindtable$?Activate@Goal_RunAwaySearchItem@@UAEXXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?Activate@Goal_RunAwaySearchItem@@UAEXXZ$0
__ehfuncinfo$?Activate@Goal_RunAwaySearchItem@@UAEXXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?Activate@Goal_RunAwaySearchItem@@UAEXXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
...
$LN12@Allocate_m:
	push	0
	push	142					; 0000008eH
	push	OFFSET $SG184804
	push	OFFSET $SG184805
	push	OFFSET $SG184806
...
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\Goal_RunAwaySearchItem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Terminate@Goal_RunAwaySearchItem@@UAEXXZ PROC		; Goal_RunAwaySearchItem::Terminate
; _this$ = ecx
...
; 60   : }
	...
	pop	ebp
	ret	0
?Terminate@Goal_RunAwaySearchItem@@UAEXXZ ENDP		; Goal_RunAwaySearchItem::Terminate
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\Goal_RunAwaySearchItem.cpp
_TEXT	SEGMENT
_this$ = -4						; size = 4
?Process@Goal_RunAwaySearchItem@@UAEHXZ PROC		; Goal_RunAwaySearchItem::Process
; _this$ = ecx
...
; 51   : }
	...
	pop	ebp
	ret	0
?Process@Goal_RunAwaySearchItem@@UAEHXZ ENDP		; Goal_RunAwaySearchItem::Process
_TEXT	ENDS
; Function compile flags: /Odtp /RTCsu
; File E:\Desktop\Raven\Raven1\Buckland_Chapter7 to 10_Raven\Goal_RunAwaySearchItem.cpp
_TEXT	SEGMENT
...
$T3 = -68						; size = 4
$T4 = -64						; size = 16
_enemy_can_see$ = -45					; size = 1
_location$ = -40					; size = 16
_target_enemy$ = -20					; size = 4
_this$ = -16						; size = 4
__$EHRec$ = -12						; size = 12
?Activate@Goal_RunAwaySearchItem@@UAEXXZ PROC		; Goal_RunAwaySearchItem::Activate
; _this$ = ecx
...
; 17   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?Activate@Goal_RunAwaySearchItem@@UAEXXZ
	mov	eax, DWORD PTR fs:0
	push	eax
...
; 23   : 
; 24   : 	Raven_Bot* target_enemy = m_pOwner->GetTargetSys()->GetTarget();
	...
	mov	DWORD PTR _target_enemy$[ebp], eax

; 25   : 	Vector2D location;

	lea	ecx, DWORD PTR _location$[ebp]
	call	??0Vector2D@@QAE@XZ			; Vector2D::Vector2D

; 26   : 	bool enemy_can_see = TRUE;

	mov	BYTE PTR _enemy_can_see$[ebp], 1
$LN2@Activate:

; 27   : 
; 28   : 	while (enemy_can_see)

	movzx	edx, BYTE PTR _enemy_can_see$[ebp]
	test	edx, edx
	je	SHORT $LN3@Activate

; 29   : 	{
; 30   : 		location = m_pOwner->GetWorld()->GetMap()->GetRandomNodeLocation();
	...
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _location$[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _location$[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _location$[ebp+8], edx
	mov	eax, DWORD PTR [eax+12]
	mov	DWORD PTR _location$[ebp+12], eax

; 31   : 
; 32   : 		if (!target_enemy->canWalkTo(location))

	sub	esp, 16					; 00000010H
	mov	ecx, esp
	mov	edx, DWORD PTR _location$[ebp]
	mov	DWORD PTR [ecx], edx
	mov	eax, DWORD PTR _location$[ebp+4]
	mov	DWORD PTR [ecx+4], eax
	mov	edx, DWORD PTR _location$[ebp+8]
	mov	DWORD PTR [ecx+8], edx
	mov	eax, DWORD PTR _location$[ebp+12]
	mov	DWORD PTR [ecx+12], eax
	mov	ecx, DWORD PTR _target_enemy$[ebp]
	call	?canWalkTo@Raven_Bot@@QBE_NUVector2D@@@Z ; Raven_Bot::canWalkTo
	movzx	ecx, al
	test	ecx, ecx
	jne	SHORT $LN4@Activate

; 33   : 			enemy_can_see = FALSE;

	mov	BYTE PTR _enemy_can_see$[ebp], 0
$LN4@Activate:
...
; 35   : 
; 36   : 	m_pOwner->GetPathPlanner()->RequestPathToPosition(location);

	sub	esp, 16					; 00000010H
	mov	edx, esp
	mov	eax, DWORD PTR _location$[ebp]
	mov	DWORD PTR [edx], eax
	mov	ecx, DWORD PTR _location$[ebp+4]
	mov	DWORD PTR [edx+4], ecx
	mov	eax, DWORD PTR _location$[ebp+8]
	mov	DWORD PTR [edx+8], eax
	mov	ecx, DWORD PTR _location$[ebp+12]
	mov	DWORD PTR [edx+12], ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+8]
...
; 37   : 	AddSubgoal(new Goal_MoveToPosition(m_pOwner, location));
	...
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _location$[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _location$[ebp+8]
	mov	DWORD PTR [eax+8], ecx
	mov	edx, DWORD PTR _location$[ebp+12]
...
; 40   : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN12@Activate
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	mov	ecx, DWORD PTR __$EHRec$[ebp]
...
_TEXT	ENDS
text$x	SEGMENT
__unwindfunclet$?Activate@Goal_RunAwaySearchItem@@UAEXXZ$0:
	push	48					; 00000030H
	...
	int	3
	int	3
__ehhandler$?Activate@Goal_RunAwaySearchItem@@UAEXXZ:
	npad	1
	npad	1
	mov	edx, DWORD PTR [esp+8]
	lea	eax, DWORD PTR [edx+12]
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?Activate@Goal_RunAwaySearchItem@@UAEXXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?Activate@Goal_RunAwaySearchItem@@UAEXXZ ENDP		; Goal_RunAwaySearchItem::Activate
; Function compile flags: /Odtp /RTCsu
