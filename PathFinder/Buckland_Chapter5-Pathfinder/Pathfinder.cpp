...
//*
  case search_iterativeDeepening:

      CreateIterativeDeepening(); break;
...
//*
void Pathfinder::CreateIterativeDeepening()
{
    //set current algorithm
    m_CurrentAlgorithm = search_iterativeDeepening;

    //create and start a timer
    PrecisionTimer timer; timer.Start();

   
    //typedef Graph_SearchIterativeDeepening <NavGraph, Heuristic_Euclid> IterativeDeepeningSearch;
